...
export const commitmentsError = (errorMessage) => ({
  type: CommitmentActionTypes.COMMITMENTS_ERROR,
...
export const updateCommitmentAsync = (commitment) => async (dispatch) => {
...
export const removeCommitmentAsync = (commitmentId) => async (dispatch) => {
  const endpoint = '/commitments';
  const method = 'DELETE';
...
export const fetchCommitmentsAsync = () => async (dispatch) => {
